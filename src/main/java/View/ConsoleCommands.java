...
public enum ConsoleCommands {
    ...
    VIEW_SELLER_PERSONAL_INFO("(?i)view\\s+personal\\s+info"),
    EDIT_SELLER_PERSONAL_INFO("(?i)edit\\s+(\\w+)"),
    ...
    VIEW_SHOPPER_PERSONAL_INFO("(?i)view\\s+personal\\s+info"),
    EDIT_SHOPPER_PERSONAL_INFO("(?i)edit\\s+(\\w+)"),
